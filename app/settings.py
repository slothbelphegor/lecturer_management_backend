...
SECRET_KEY = 'django-insecure-g4-dknntvgy-2(_y5sy##lsina47=8*-r3)a^zfyr42_i24-!5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["lecturer-management-backend.onrender.com", "127.0.0.1", "localhost"]
...
AUTHENTICATION_BACKENDS = [
    ...
    'app.backends.EmailOrUsernameModelBackend',  # Custom backend, đăng nhập bằng username hoặc password 
]
